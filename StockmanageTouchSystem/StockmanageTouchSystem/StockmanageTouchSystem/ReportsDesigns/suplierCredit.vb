...
Public Class suplierCredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "StockmanageTouchSystem.suplierCredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsuplierCredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As suplierCredit = New suplierCredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
