...
Public Class ChaqueOutReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "StockmanageTouchSystem.ChaqueOutReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChaqueOutReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChaqueOutReport = New ChaqueOutReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
