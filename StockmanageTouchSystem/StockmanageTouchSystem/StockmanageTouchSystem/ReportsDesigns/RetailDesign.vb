...
Public Class RetailDesign
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "StockmanageTouchSystem.RetailDesign.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRetailDesign
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RetailDesign = New RetailDesign()
        rpt.Site = Me.Site
        Return rpt
    End Function
